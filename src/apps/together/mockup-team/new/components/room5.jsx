class Room extends React.Component { 
  render(){
    var roomtitle = new Firebase('https://team-polive.firebaseio.com/rooms/Room5');
    ...
    this.props.data.room = 'Room5'
	console.log('Room5 set!')
	...
	roomusers.orderByChild("room").equalTo("Room5").on('value', function(data){
