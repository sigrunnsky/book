class Room extends React.Component { 
  render(){
    var roomtitle = new Firebase('https://team-polive.firebaseio.com/rooms/Room6');
    ...
    this.props.data.room = 'Room6'
	console.log('Room6 set!')
	...
	roomusers.orderByChild("room").equalTo("Room6").on('value', function(data){
