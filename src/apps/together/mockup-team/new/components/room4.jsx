class Room extends React.Component { 
  render(){
    var roomtitle = new Firebase('https://team-polive.firebaseio.com/rooms/Room4');
    ...
    this.props.data.room = 'Room4'
	console.log('Room4 set!')
	...
	roomusers.orderByChild("room").equalTo("Room4").on('value', function(data){
