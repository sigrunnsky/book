class Room extends React.Component { 
  render(){
    var roomtitle = new Firebase('https://team-polive.firebaseio.com/rooms/Room3');
	...
	roomusers.orderByChild("room").equalTo("Room3").on('value', function(data){
