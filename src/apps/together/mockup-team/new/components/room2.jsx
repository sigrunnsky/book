class Room extends React.Component { 
  render(){
    var roomtitle = new Firebase('https://team-polive.firebaseio.com/rooms/Room2');
	...
	roomusers.orderByChild("room").equalTo("Room2").on('value', function(data){
